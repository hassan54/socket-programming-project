...
void GetFileFromPeer(char* peerInfo,string fileName)
{
    ...
    int fileSize;
    ssize_t len;
    string fileLocation="./p2p-files/" + fileName;
    ...
    //---------else the socket fd is a exsisting connection socket fd.
            ...
            {   
                ...
                {  
                    ...
                    string fileLocation="./p2p-files/" + string(buff);
...
void fetchFromServer(int sockfd)
{
    ...
    if(strcmp(peerInfo,"Requested File is not in P2P system!"))
    {
        ...
        GetFileFromPeer(peerInfo,fetchFile);
   }
...
{ 
    ...
    else
    {
        ...
        LoopBack:  
        printf("-----------------------------------\n");      
        printf("Press 1 to Publish\n");
        printf("Press 2 to Fetch\n");
